using BlogManager.Api.Services;
using BlogManager.Application.DTOs.Settings;
using BlogManager.Application.Interfaces;
...
using BlogManager.Infrastructure.Identity.Services;
using BlogManager.Infrastructure.Shared.Services;
...
namespace BlogManager.Api.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\BlogManager.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
